...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/yura/Projects/FrameworkTest/sf/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/FrameworkBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SecurityBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/TwigBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/MonologBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/MonologBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SwiftmailerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/SwiftmailerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/DoctrineBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/AsseticBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/Symfony/Bundle/AsseticBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SensioFrameworkExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/Sensio/Bundle/FrameworkExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/JMSSecurityExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/JMS/SecurityExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SorienDataGridBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SorienDataGridBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SorienDataGridBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/Sorien/DataGridBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TestBlogBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/TestBlogBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TestBlogBundle', '/home/yura/Projects/FrameworkTest/sf/src/Test/BlogBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/AcmeDemoBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/home/yura/Projects/FrameworkTest/sf/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SensioDistributionBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/Sensio/Bundle/DistributionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/home/yura/Projects/FrameworkTest/sf/app/Resources/SensioGeneratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/home/yura/Projects/FrameworkTest/sf/vendor/bundles/Sensio/Bundle/GeneratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/home/yura/Projects/FrameworkTest/sf/app/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/yura/Projects/FrameworkTest/sf/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'fwtest_sf', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => 'root', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_31d890160a73ae3f39afa305c67de580');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_31d890160a73ae3f39afa305c67de580');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_31d890160a73ae3f39afa305c67de580');
        ...
        $d->setProxyDir('/home/yura/Projects/FrameworkTest/sf/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/yura/Projects/FrameworkTest/sf/app/Resources');
    }
    ...
    /**
     * Gets the 'form.type_guesser.grid' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sorien\DataGridBundle\Form\GridTypeGuesser A Sorien\DataGridBundle\Form\GridTypeGuesser instance.
     */
    protected function getForm_TypeGuesser_GridService()
    {
        return $this->services['form.type_guesser.grid'] = new \Sorien\DataGridBundle\Form\GridTypeGuesser($this->get('grid.mapping.manager'));
    }
     ...
     *
     * @return Sorien\DataGridBundle\Grid\Grid A Sorien\DataGridBundle\Grid\Grid instance.
     */
    protected function getGridService()
    {
        $instance = new \Sorien\DataGridBundle\Grid\Grid($this);

        $instance->addColumnExtension($this->get('grid.column.text'));
        $instance->addColumnExtension($this->get('grid.column.select'));
        $instance->addColumnExtension($this->get('grid.column.range'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sorien\DataGridBundle\Grid\GridManager A Sorien\DataGridBundle\Grid\GridManager instance.
     */
    protected function getGrid_ManagerService()
    {
        return $this->services['grid.manager'] = new \Sorien\DataGridBundle\Grid\GridManager($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sorien\DataGridBundle\Grid\Mapping\Metadata\Manager A Sorien\DataGridBundle\Grid\Mapping\Metadata\Manager instance.
     */
    protected function getGrid_Mapping_ManagerService()
    {
        $this->services['grid.mapping.manager'] = $instance = new \Sorien\DataGridBundle\Grid\Mapping\Metadata\Manager($this->get('form.factory'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return Sorien\DataGridBundle\Grid\Mapping\Driver\Annotation A Sorien\DataGridBundle\Grid\Mapping\Driver\Annotation instance.
     */
    protected function getGrid_Metadata_Driver_AnnotationService()
    {
        return $this->services['grid.metadata.driver.annotation'] = new \Sorien\DataGridBundle\Grid\Mapping\Driver\Annotation($this->get('annotation_reader'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/yura/Projects/FrameworkTest/sf/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/home/yura/Projects/FrameworkTest/sf/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/yura/Projects/FrameworkTest/sf/app/config/routing_dev.yml', array('cache_dir' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/yura/Projects/FrameworkTest/sf/app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/yura/Projects/FrameworkTest/sf/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Sorien\DataGridBundle\Twig\DataGridExtension($a));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/TwigBundle/DependencyInjection/../../../Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/home/yura/Projects/FrameworkTest/sf/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/yura/Projects/FrameworkTest/sf/app/cache/dev/assetic/assets');
    }
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\BlankColumn A Sorien\DataGridBundle\Grid\Column\BlankColumn instance.
     */
    protected function getGrid_Column_BlankService()
    {
        return $this->services['grid.column.blank'] = new \Sorien\DataGridBundle\Grid\Column\BlankColumn();
    }
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\BooleanColumn A Sorien\DataGridBundle\Grid\Column\BooleanColumn instance.
     */
    protected function getGrid_Column_BooleanService()
    {
        return $this->services['grid.column.boolean'] = new \Sorien\DataGridBundle\Grid\Column\BooleanColumn();
    }
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\DateColumn A Sorien\DataGridBundle\Grid\Column\DateColumn instance.
     */
    protected function getGrid_Column_DateService()
    {
        return $this->services['grid.column.date'] = new \Sorien\DataGridBundle\Grid\Column\DateColumn();
    }

    /**
     * Gets the 'grid.column.range' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\RangeColumn A Sorien\DataGridBundle\Grid\Column\RangeColumn instance.
     */
    protected function getGrid_Column_RangeService()
    {
        return $this->services['grid.column.range'] = new \Sorien\DataGridBundle\Grid\Column\RangeColumn();
    }

    /**
     * Gets the 'grid.column.select' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\SelectColumn A Sorien\DataGridBundle\Grid\Column\SelectColumn instance.
     */
    protected function getGrid_Column_SelectService()
    {
        return $this->services['grid.column.select'] = new \Sorien\DataGridBundle\Grid\Column\SelectColumn();
    }
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Sorien\DataGridBundle\Grid\Column\TextColumn A Sorien\DataGridBundle\Grid\Column\TextColumn instance.
     */
    protected function getGrid_Column_TextService()
    {
        return $this->services['grid.column.text'] = new \Sorien\DataGridBundle\Grid\Column\TextColumn();
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/yura/Projects/FrameworkTest/sf/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/yura/Projects/FrameworkTest/sf/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev',
            'kernel.logs_dir' => '/home/yura/Projects/FrameworkTest/sf/app/logs',
            'kernel.bundles' => array(
                ...
                'SorienDataGridBundle' => 'Sorien\\DataGridBundle\\SorienDataGridBundle',
            ...
            'debug.container.dump' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/yura/Projects/FrameworkTest/sf/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:/home/yura/Projects/FrameworkTest/sf/app/cache/dev/profiler.db',
            ...
            'router.resource' => '/home/yura/Projects/FrameworkTest/sf/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/home/yura/Projects/FrameworkTest/sf/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/yura/Projects/FrameworkTest/sf/app/../web',
            'assetic.write_to' => '/home/yura/Projects/FrameworkTest/sf/app/../web',
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.sass.bin' => '/home/yura/.rvm/gems/ruby-1.9.2-p290/bin/sass',
            ...
            'grid.twig_extension.class' => 'Sorien\\DataGridBundle\\Twig\\DataGridExtension',
            'grid.base.class' => 'Sorien\\DataGridBundle\\Grid\\Grid',
            'grid.manager.base.class' => 'Sorien\\DataGridBundle\\Grid\\GridManager',
            'grid.column.text.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\TextColumn',
            'grid.column.select.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\SelectColumn',
            'grid.column.range.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\RangeColumn',
            'grid.column.date.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\DateColumn',
            'grid.column.blank.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\BlankColumn',
            'grid.column.boolean.class' => 'Sorien\\DataGridBundle\\Grid\\Column\\BooleanColumn',
